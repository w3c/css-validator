...
<p>Нет. Это надежная и полезная утилита, но это всего лишь программа, и, как у любого программного обеспечения, у нее есть <a href="https://github.com/w3c/css-validator/issues">ошибки и проблемы</a>. Актуальный справочник по таблицам каскадных стилей есть в их <a href="http://www.w3.org/Style/CSS/#specs">спецификации</a>.</p>
...
<p>Конечно. Если вы программируете на Java, то можете помочь проекту, проверяя, улучшая, <a href="https://github.com/w3c/css-validator/issues">исправляя</a> исходный <a href="#code">код</a>, либо добавляя новые функции.</p>
