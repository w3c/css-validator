...
<html xmlns="http://www.w3.org/1999/xhtml" lang="nl" xml:lang="nl">
  ...
  <body>
    ...
    <p>
      Welkom bij de W3C Validatie Service voor CSS!	
    </p>
    <hr />
    <h2>Valideer uw cascading style sheet</h2>
    
    <p>
      Typ de CSS code in die u wilt laten valideren:
    </p>
	...
	<option value="presentation">presentation</option>
      ...
      <br />
      <input type="submit" value="Verstuur voor validatie" />
    ...
    <p>
      ...
      style sheet een correcte grammaticale opbouw heeft. 
      Dit betekent dat u <a href="http://validator.w3.org/">correct
      HTML</a> dient te gebruiken.
    </p>
