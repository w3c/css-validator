...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
  ...
  <body>
   <div id="banner">
    ...
    <fieldset id="validate-by-input"><legend>Validar introduciendo CSS directamente</legend>
    <form action="validator" method="get">
      <p>
        Introduzca el código CSS que quiera validar:
      </p>
      <p>
      <textarea name="text" rows="12" cols="75">
      </textarea><br />
	...
	<option value="tv">televisión</option>
      ...
      <p>
      <input type="submit" value="Enviar el código CSS para su validación" />
      </p>
    </form>
</fieldset>    
    ...
    <p class="copyright">
			<a rel="Copyright" href="http://www.w3.org/Consortium/Legal/ipr-notice#Copyright" hreflang="en-us" xml:lang="en-us">Copyright</a> &copy; 1994-2004
