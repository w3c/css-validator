...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
  ...
  <div id="banner">
    ...
    <fieldset id="validate-by-upload"><legend>Validar enviando el archivo</legend>
    <form action="validator" method="post" enctype="multipart/form-data">
    <p>
      Indique el documento que quiera validar (sólo archivos CSS):
    </p>
	...
	<option value="tv">televisión</option>
      ...
      <p>
      <input type="submit" value="Enviar este archivo CSS para su validación" />
      </p>
    </form>
</fieldset> 
