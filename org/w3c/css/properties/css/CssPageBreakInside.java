 ...
 * @since CSS2
 */
public class CssPageBreakInside extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (style0.cssPageBreakInside != null) {
            style0.addRedefinitionWarning(ac, this);
        }
        style0.cssPageBreakInside = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            ...
            return ((Css2Style) style).cssPageBreakInside;
        }
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssPageBreakInside &&
                value.equals(((CssPageBreakInside) property).value));
    }
