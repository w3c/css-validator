...
public class CssScrollPaddingBlock extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssScrollPaddingBlock != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssScrollPaddingBlock &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getScrollPaddingBlock();
		} else {
			return ((Css3Style) style).cssScrollPaddingBlock;
		}
	}
}
