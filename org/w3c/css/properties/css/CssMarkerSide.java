...
public class CssMarkerSide extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		if (((Css3Style) style).cssMarkerSide != null)
			style.addRedefinitionWarning(ac, this);
		((Css3Style) style).cssMarkerSide = this;
	}
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssMarkerSide &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getMarkerSide();
		} else {
			return ((Css3Style) style).cssMarkerSide;
		}
	}
}
