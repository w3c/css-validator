 ...
 * @since CSS3
 */
public class CssBoxSuppress extends CssProperty {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssBoxSuppress &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getBoxSuppress();
        } else {
            return ((Css3Style) style).cssBoxSuppress;
        }
    }
}
