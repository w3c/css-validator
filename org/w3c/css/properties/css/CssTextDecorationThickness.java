...
public class CssTextDecorationThickness extends CssProperty {
    ...
    /**
     * Creates a new CssTextDecorationThickness
     *
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssTextDecorationThickness != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssTextDecorationThickness &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getTextDecorationThickness();
        } else {
            return ((Css3Style) style).cssTextDecorationThickness;
        }
    }
}
