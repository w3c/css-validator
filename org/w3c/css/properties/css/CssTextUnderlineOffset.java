...
public class CssTextUnderlineOffset extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssTextUnderlineOffset != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssTextUnderlineOffset &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getTextUnderlineOffset();
        } else {
            return ((Css3Style) style).cssTextUnderlineOffset;
        }
    }
}
