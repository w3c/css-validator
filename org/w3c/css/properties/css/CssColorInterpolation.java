 ...
 * @since SVG
 */
public class CssColorInterpolation extends CssProperty {

    /**
     * Create a new CssInterpolation
     */
    public CssColorInterpolation() {
    }

    /**
     * Creates a new CssInterpolation
     *
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssColorInterpolation != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssColorInterpolation &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            ...
            return ((SVGBasicStyle) style).cssColorInterpolation;
        }
    }
}
