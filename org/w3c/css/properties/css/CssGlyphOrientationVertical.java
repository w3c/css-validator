...
public class CssGlyphOrientationVertical extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssGlyphOrientationVertical != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssGlyphOrientationVertical &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((SVGBasicStyle) style).getGlyphOrientationVertical();
		} else {
			return ((SVGBasicStyle) style).cssGlyphOrientationVertical;
		}
	}
}
