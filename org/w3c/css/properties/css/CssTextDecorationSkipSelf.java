...
public class CssTextDecorationSkipSelf extends CssProperty {
    ...
    public final String getPropertyName() {
        return "text-decoration-skip-self";
    }
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssTextDecorationSkipSelf != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssTextDecorationSkipSelf &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getTextDecorationSkipSelf();
        } else {
            return ((Css3Style) style).cssTextDecorationSkipSelf;
        }
    }
}
