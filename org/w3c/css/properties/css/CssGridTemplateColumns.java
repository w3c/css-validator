...
public class CssGridTemplateColumns extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssGridTemplateColumns != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssGridTemplateColumns &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getGridTemplateColumns();
		} else {
			return ((Css3Style) style).cssGridTemplateColumns;
		}
	}
}
