...
public class CssForcedColorAdjust extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssForcedColorAdjust != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssForcedColorAdjust &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getForcedColorAdjust();
        } else {
            return ((Css3Style) style).cssForcedColorAdjust;
        }
    }
}
