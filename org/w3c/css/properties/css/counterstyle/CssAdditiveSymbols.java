...
package org.w3c.css.properties.css.counterstyle;
...
public class CssAdditiveSymbols extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.counterStyleCssAdditiveSymbols != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAdditiveSymbols &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getCounterStyleCssAdditiveSymbols();
		} else {
			return ((Css3Style) style).counterStyleCssAdditiveSymbols;
		}
	}
}
