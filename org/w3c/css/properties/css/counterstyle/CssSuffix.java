...
public class CssSuffix extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.counterStyleCssSuffix != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssSuffix &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getCounterStyleCssSuffix();
		} else {
			return ((Css3Style) style).counterStyleCssSuffix;
		}
	}
}
