...
public class CssPrefix extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.counterStyleCssPrefix != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssPrefix &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getCounterStyleCssPrefix();
		} else {
			return ((Css3Style) style).counterStyleCssPrefix;
		}
	}
}
