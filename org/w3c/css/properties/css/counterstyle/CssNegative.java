...
public class CssNegative extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.counterStyleCssNegative != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssNegative &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getCounterStyleCssNegative();
		} else {
			return ((Css3Style) style).counterStyleCssNegative;
		}
	}
}
