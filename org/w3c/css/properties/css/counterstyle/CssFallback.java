...
public class CssFallback extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.counterStyleCssFallback != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssFallback &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getCounterStyleCssFallback();
		} else {
			return ((Css3Style) style).counterStyleCssFallback;
		}
	}
}
