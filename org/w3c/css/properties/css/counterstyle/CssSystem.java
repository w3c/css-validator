...
public class CssSystem extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.counterStyleCssSystem != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssSystem &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getCounterStyleCssSystem();
		} else {
			return ((Css3Style) style).counterStyleCssSystem;
		}
	}
}
