...
public class CssSymbols extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.counterStyleCssSymbols != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssSymbols &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getCounterStyleCssSymbols();
		} else {
			return ((Css3Style) style).counterStyleCssSymbols;
		}
	}
}
