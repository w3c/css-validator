...
public class CssInitialLetterAlign extends CssProperty {
	...
	/**
	 * Creates a new CssInitialLetterAlign
	 *
	 * @param expression The expression for this property
	 * @throws org.w3c.css.util.InvalidParamException
	 *          Expressions are incorrect
	 */
	public CssInitialLetterAlign(ApplContext ac, CssExpression expression, boolean check)
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssInitialLetterAlign != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssInitialLetterAlign &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getInitialLetterAlign();
		} else {
			return ((Css3Style) style).cssInitialLetterAlign;
		}
	}
}
