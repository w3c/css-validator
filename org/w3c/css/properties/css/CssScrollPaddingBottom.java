...
public class CssScrollPaddingBottom extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssScrollPaddingBottom != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssScrollPaddingBottom &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getScrollPaddingBottom();
		} else {
			return ((Css3Style) style).cssScrollPaddingBottom;
		}
	}
}
