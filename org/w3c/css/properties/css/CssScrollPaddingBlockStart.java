...
public class CssScrollPaddingBlockStart extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssScrollPaddingBlockStart != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssScrollPaddingBlockStart &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getScrollPaddingBlockStart();
		} else {
			return ((Css3Style) style).cssScrollPaddingBlockStart;
		}
	}
}
