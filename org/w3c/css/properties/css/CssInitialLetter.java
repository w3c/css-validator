...
public class CssInitialLetter extends CssProperty {
	...
	/**
	 * Creates a new CssInitialLetter
	 *
	 * @param expression The expression for this property
	 * @throws org.w3c.css.util.InvalidParamException
	 *          Expressions are incorrect
	 */
	public CssInitialLetter(ApplContext ac, CssExpression expression, boolean check)
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssInitialLetter &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getInitialLetter();
		} else {
			return ((Css3Style) style).cssInitialLetter;
		}
	}
}
