...
public class CssScrollPaddingRight extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssScrollPaddingRight != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssScrollPaddingRight &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getScrollPaddingRight();
        } else {
            return ((Css3Style) style).cssScrollPaddingRight;
        }
    }
}
