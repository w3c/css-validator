...
public class CssMarker extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssMarker != null) {
			...
			if (s.cssMarkerStart != null) {
				style.addRedefinitionWarning(ac, s.cssMarkerStart);
			}
			if (s.cssMarkerMid != null) {
				style.addRedefinitionWarning(ac, s.cssMarkerMid);
			}
			if (s.cssMarkerEnd != null) {
				style.addRedefinitionWarning(ac, s.cssMarkerEnd);
			}
		}
		s.cssMarker = this;
	}
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			...
			return ((SVGStyle) style).cssMarker;
		}
	}
}
