 ...
 * @since CSS2
 */
public class CssPageBreakBefore extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (style0.cssPageBreakBefore != null) {
            style0.addRedefinitionWarning(ac, this);
        }
        style0.cssPageBreakBefore = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            ...
            return ((Css2Style) style).cssPageBreakBefore;
        }
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssPageBreakBefore &&
                value.equals(((CssPageBreakBefore) property).value));
    }
