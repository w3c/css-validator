 ...
 * @since CSS3
 */
public class CssBackgroundBlendMode extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssBackgroundBlendMode != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssBackgroundBlendMode &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getBackgroundBlendMode();
		} else {
			return ((Css3Style) style).cssBackgroundBlendMode;
		}
	}
}
