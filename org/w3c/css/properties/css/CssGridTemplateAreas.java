...
public class CssGridTemplateAreas extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssGridTemplateAreas != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssGridTemplateAreas &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getGridTemplateAreas();
        } else {
            return ((Css3Style) style).cssGridTemplateAreas;
        }
    }
}
