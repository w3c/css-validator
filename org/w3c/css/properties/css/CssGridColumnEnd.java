...
public class CssGridColumnEnd extends CssProperty {
    ...
    /**
     * Creates a new CssGridColumnEnd
     *
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssGridColumnEnd &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getGridColumnEnd();
        } else {
            return ((Css3Style) style).cssGridColumnEnd;
        }
    }
}
