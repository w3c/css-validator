 ...
 * @since SVG
 */
public class CssEnableBackground extends CssProperty {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssEnableBackground &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            ...
            return ((SVGBasicStyle) style).cssEnableBackground;
        }
    }
}
