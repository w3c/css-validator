 ...
 * @since CSS2
 */
public class CssWidows extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (style0.cssWidows != null) {
            style0.addRedefinitionWarning(ac, this);
        }
        style0.cssWidows = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            ...
            return ((Css2Style) style).cssWidows;
        }
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssWidows &&
                value.equals(((CssWidows) property).value));
    }
