...
public class CssScrollPaddingInlineEnd extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssScrollPaddingInlineEnd != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssScrollPaddingInlineEnd &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getScrollPaddingInlineEnd();
		} else {
			return ((Css3Style) style).cssScrollPaddingInlineEnd;
		}
	}
}
