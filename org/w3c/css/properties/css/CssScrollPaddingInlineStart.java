...
public class CssScrollPaddingInlineStart extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssScrollPaddingInlineStart != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssScrollPaddingInlineStart &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getScrollPaddingInlineStart();
		} else {
			return ((Css3Style) style).cssScrollPaddingInlineStart;
		}
	}
}
