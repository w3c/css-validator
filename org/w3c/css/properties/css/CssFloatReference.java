...
public class CssFloatReference extends CssProperty {
    ...
    /**
     * Creates a new CssFloatReference
     *
     * @param expression The expression for this property
     * @throws org.w3c.css.util.InvalidParamException
     *          Expressions are incorrect
     */
    public CssFloatReference(ApplContext ac, CssExpression expression, boolean check)
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssFloatReference &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getFloatReference();
        } else {
            return ((Css3Style) style).cssFloatReference;
        }
    }
}
