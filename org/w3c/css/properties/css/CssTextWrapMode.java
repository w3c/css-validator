 ...
 * @since CSS3
 */
public class CssTextWrapMode extends CssProperty {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssTextWrapMode &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getTextWrapMode();
        } else {
            return ((Css3Style) style).cssTextWrapMode;
        }
    }
}
