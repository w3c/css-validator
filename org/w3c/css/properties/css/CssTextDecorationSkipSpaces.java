...
public class CssTextDecorationSkipSpaces extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssTextDecorationSkipSpaces != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssTextDecorationSkipSpaces &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getTextDecorationSkipSpaces();
        } else {
            return ((Css3Style) style).cssTextDecorationSkipSpaces;
        }
    }
}
