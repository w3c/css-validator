...
public class CssScrollPaddingInline extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssScrollPaddingInline != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssScrollPaddingInline &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getScrollPaddingInline();
		} else {
			return ((Css3Style) style).cssScrollPaddingInline;
		}
	}
}
