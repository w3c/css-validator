...
public class MediaOverflowBlock extends MediaFeature {
    ...
    public MediaOverflowBlock(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaOverflowBlock ms = (MediaOverflowBlock) other;
