...
/**
 * @spec https://www.w3.org/TR/2017/CR-mediaqueries-4-20170905/#descdef-media-any-pointer
 */
public class MediaAnyPointer extends MediaFeature {

    public static final CssIdent[] allowed_values;

    static {
        String[] _allowed_values = {"none", "coarse", "fine"};
    ...
    /**
     * Create a new MediaAnyPointer
     */
    public MediaAnyPointer() {
    }
     ...
     */
    public MediaAnyPointer(ApplContext ac, String modifier,
    ...
    public MediaAnyPointer(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaAnyPointer ms = (MediaAnyPointer) other;
