//
//
// (c) COPYRIGHT MIT, ECRIM, Keio, Beihangg 2019
...
/**
 * @spec https://www.w3.org/TR/2017/CR-mediaqueries-4-20170905/#descdef-media-update
 */
public class MediaUpdate extends MediaFeature {

    public static final CssIdent[] allowed_values;

    static {
        String[] _allowed_values = {"none", "slow", "fast"};
     ...
     */
    public MediaUpdate(ApplContext ac, String modifier,
    ...
    public MediaUpdate(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaUpdate ms = (MediaUpdate) other;
