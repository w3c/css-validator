...
public class MediaPrefersContrast extends MediaFeature {
    ...
    /**
     * Create a new MediaPrefersContrast
     */
    public MediaPrefersContrast() {
    }
     ...
     */
    public MediaPrefersContrast(ApplContext ac, String modifier,
    ...
    public MediaPrefersContrast(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaPrefersContrast mo = (MediaPrefersContrast) other;
