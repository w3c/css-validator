...
((CssCalc) v).setParenthesis();
    ...
    case FUNCTIONCALC:{
      v = mathcalc();
((CssCalc) v).setImplicitFunction(false);
      break;
      }
    case FUNCTIONMAX:{
      v = mathmax();
