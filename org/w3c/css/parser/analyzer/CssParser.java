...
n.image = Util.strip(n.image);
  ...
  private boolean jj_3R_213()
 {
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[292];
  ...
  public CssParser(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 292; i++) jj_la1[i] = -1;
