...
// here we add the default media if not present
    ...
    final public void unused_production_definition() throws ParseException {
        CssExpression values = new CssExpression();
...
// TODO fix the error
    ...
    final public void counterstyle() throws ParseException {
        Token n;
        ArrayList<CssProperty> v;
        AtRule old = getAtRule();
...
/*
        ...
        while (true) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
                ...
                case DIV: {
                    ...
                    n = jj_consume_token(NUMBER);
                    v2 = new CssNumber();
                    v2.set(addOperator(operator, n.image), ac);
                    break;
                }
                default:
                    jj_la1[172] = jj_gen;
            ...
            case NUMBER: {
                ...
                switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
                    case NUMBER: {
                        n = jj_consume_token(NUMBER);
                        v = new CssNumber();
                        v.set(addOperator(operator, n.image), ac);
                        break;
                    }
                    case PERCENTAGE: {
                        n = jj_consume_token(PERCENTAGE);
    ...
    final public CssCheckableValue attr() throws ParseException {
        CssAttr v = null;
        Token n = null;
