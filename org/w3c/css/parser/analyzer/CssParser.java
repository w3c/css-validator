...
n.image = Util.strip(n.image);
  ...
  private boolean jj_3_19()
 {
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[331];
  ...
  public CssParser(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 331; i++) jj_la1[i] = -1;
