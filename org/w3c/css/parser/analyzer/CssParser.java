...
((CssCalc) v).setParenthesis();
    ...
    case FUNCTIONVAR:{
      ...
      jj_consume_token(LPARAN);
CssCalc c = new CssCalc(); c.markCssVariable(); {if ("" != null) return c;}
      break;
      }
    default:
      jj_la1[271] = jj_gen;
...
v = new CssAttr();
  ...
  final public CssValue functionvar() throws ParseException {Token n;
 CssExpression exp = null;
 CssExpression e;
 CssVariable var;
