...
nameIsFirst = true;
      ...
      case 144:{
        c1 = jj_consume_token(144);
        break;
        }
      case 146:{
        c1 = jj_consume_token(146);
        break;
        }
      default:
        jj_la1[215] = jj_gen;
      ...
      case FUNCTION:{
        ...
        case 146:{
          ...
          case 144:{
            c2 = jj_consume_token(144);
            break;
            }
          case 146:{
            c2 = jj_consume_token(146);
            break;
            }
          default:
            jj_la1[220] = jj_gen;
...
n.image = Util.strip(n.image);
 ...
 {
    if (jj_scan_token(FUNCTIONLANG)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_scan_token(21)) { jj_scanpos = xsp; break; }
