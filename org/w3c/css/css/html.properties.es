...
go-warnings: <li><a href="#warnings">Ir a los Advertencias</a></li>
...
se encuentra el HTML que puede usar para añadir el icono a su página Web:</p> <pre class='example'> \n\
&lt;p>\n\
...
(cierre la etiqueta img con /&gt; si utiliza XHTML)\
<p> \
Si lo desea, puede descargar una copia de la imagen para guardarla en su \
directorio web local y cambiar el fragmento anterior de HTML para referenciar \
